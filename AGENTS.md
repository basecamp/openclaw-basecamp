...
An external OpenClaw channel plugin that makes Basecamp a first-class participant in OpenClaw's agent framework. Campfire chats, card tables, to-do lists, check-ins, pings, message boards — every Basecamp surface becomes a live interaction point for AI agents.
